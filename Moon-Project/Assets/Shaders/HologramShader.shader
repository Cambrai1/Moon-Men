...
Shader "Hologram Shader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 uv_TexCoord48 = i.uv_texcoord * float2( 2,2 ) + temp_cast_0;
			float2 temp_cast_1 = (temp_output_46_0).xx;
			float2 uv_TexCoord50 = i.uv_texcoord * float2( -5,-5 ) + temp_cast_1;
...
/*ASEBEGIN
Version=16100
251;92;1302;655;1631.776;-372.2602;1.3;True;False
...
Node;AmplifyShaderEditor.TFHCIf;47;-386.9148,668.0162;Float;True;6;0;FLOAT;0.6;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;7;-373.339,-119.4936;Float;False;Property;_Color;Color;0;0;Create;True;0;0;False;0;0,0,0,0;0,0.3845288,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=D462C46F899E5F64244A8B5F32AAC9C31123FB8E