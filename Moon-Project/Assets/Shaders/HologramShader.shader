...
Shader "Hologram Shader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_34_0 = distance( ( _WaveOrigin - ase_worldPos ) , float3( 0,0,0 ) );
			float temp_output_21_0 = ( ( sin( ( ( temp_output_34_0 * _Stripiness ) + ( _Time.y * _Speed ) ) ) + 1.0 ) / 2.0 );
...
/*ASEBEGIN
Version=16100
420;174;1069;745;1875.272;187.6144;1.3;False;False
Node;AmplifyShaderEditor.WorldPosInputsNode;15;-2080,144;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector3Node;33;-2080,0;Float;False;Property;_WaveOrigin;Wave Origin;5;0;Create;True;0;0;False;0;0,0,0;10,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;19;-1264,320;Float;False;Property;_Speed;Speed;4;0;Create;True;0;0;False;0;-20;-20;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-1344,176;Float;False;Property;_Stripiness;Stripiness;3;0;Create;True;0;0;False;0;50;100;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;7;-373.339,-119.4936;Float;False;Property;_Color;Color;0;0;Create;True;0;0;False;0;0,0,0,0;0,0.384529,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=A23DF8C289AB40A46AAE0E428204B7BCA611EF6E