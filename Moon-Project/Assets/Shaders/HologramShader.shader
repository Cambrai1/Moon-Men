...
Shader "Hologram Shader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_21_0 = ( ( sin( ( ( ( distance( ( _WaveOrigin - ( ase_worldPos - _LocalOffset ) ) , float3( 0,0,0 ) ) / 3.0 ) * _Stripiness ) + ( _Time.y * _Speed ) ) ) + 1.0 ) / 2.0 );
...
/*ASEBEGIN
Version=16100
-1631;112;1611;993;2540.335;387.9662;1;True;True
Node;AmplifyShaderEditor.Vector3Node;43;-2080,288;Float;False;Property;_LocalOffset;Local Offset;5;0;Create;True;0;0;False;0;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldPosInputsNode;15;-2080,144;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleSubtractOpNode;45;-1764.335,320.0338;Float;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.Vector3Node;33;-2080,0;Float;False;Property;_WaveOrigin;Wave Origin;6;0;Create;True;0;0;False;0;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.PosVertexDataNode;44;-2008.335,449.0338;Float;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=26E14EF7F8018089C42B7FA88B1290B0C9D11D11