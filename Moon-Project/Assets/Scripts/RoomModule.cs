...
public class RoomModule : MonoBehaviour
{
    ...
    public List<ModuleConnector> GetExits()
    {
        ...
        {
            if (connectors[i].linkedConnector != null) m_remainingExits.RemoveAt(i);
            if (connectors[i].isEntrance == true) m_remainingExits.RemoveAt(i);
        }
...
public class ModuleConnector
{
    ...
    public RoomModule ParentModule() { return parentModule; }

    [SerializeField]
    public ModuleConnector linkedConnector;
}